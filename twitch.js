  ...
  var loadButton = setInterval(function() {
    if (document.querySelector('.clips-editor-slider-background.tw-mg-y-4')) {
      if (!document.querySelector('.quickChimpButton')) {
        document.querySelector('.tw-align-items-center.tw-flex.tw-justify-content-between.tw-pd-t-1').insertAdjacentHTML('afterend','<p class="quickChimpButton" style="cursor: pointer; padding: 5px; font-size: 25px; background-color:#ff4500; text-align: center; color: white; margin-top: 10px; border-radius: 5px;">Publish and post to r/LivestreamFail</p>');
      } else {
